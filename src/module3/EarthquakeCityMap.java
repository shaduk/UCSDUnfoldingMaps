...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		for(PointFeature eq: earthquakes){
			SimplePointMarker tempmarker = createMarker(eq);
	...
	private SimplePointMarker createMarker(PointFeature feature) {
		...
		SimplePointMarker tempmarker = new SimplePointMarker(feature.getLocation());
	...
	private void addKey() {
		...
		PShape square, redcircle, yellowcircle, bluecircle; 
		
		square = createShape(RECT, 0, 0, 170, 300);
		square.setFill(color(211, 211, 211));
		...
		redcircle = createShape(ELLIPSE, 0, 0, 20, 20);
		redcircle.setFill(color(255,0,0));
		shape(redcircle, 30, 100);
		
		textSize(12);
		text("5.0+ Magnitude", 60, 110); 
		fill(0, 0, 0);
		
		yellowcircle = createShape(ELLIPSE, 0, 0, 15, 15);
		yellowcircle.setFill(color(255,255,0));
		shape(yellowcircle, 30, 170);
		
		textSize(12);
		text("4.0+ Magnitude", 60, 180); 
		fill(0, 0, 0);
		
		bluecircle = createShape(ELLIPSE, 0, 0, 15, 15);
		bluecircle.setFill(color(0,0,255));
		shape(bluecircle, 30, 250);
